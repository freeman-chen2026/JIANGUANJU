...
async function handleAirportBlock(blockIndex, city, label) {{
    ...
    if (info.zone === "境内") {{
        ...
        if (blockIndex === 2) {{
            zoneSelectXPath = '/html/body/div[1]/div[3]/div/div[2]/form/div[11]/div[2]/div[2]/div/div[2]/div/select[1]';
            zoneSelect2XPath = '/html/body/div[1]/div[3]/div/div[2]/form/div[11]/div[2]/div[2]/div/div[2]/div/select[2]';
            airportNameInputXPath = '/html/body/div[1]/div[3]/div/div[2]/form/div[11]/div[2]/div[2]/div/div[2]/div/input';
        }} else {{
...
tab1, tab2, tab3, tab4 = st.tabs(["📋 每日飞行数据-10：00发", "📄 每日通航运行情况跟踪表-16：30发", "📊 天成商务航空每日运行跟踪-16：30发", "📜 通航脚本"])
...
st.caption("💡 功能1自动更新模板的汇总数据；功能2按航段逐行填写备案表；功能3生成每日运行跟踪汇总一行；功能4生成浏览器控制台脚本。")
